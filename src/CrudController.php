...
abstract class CrudController extends BaseController {
    ...
    public function index(Request $request) {
        if(static::$authorize) $this->authorize('viewAny', static::$model);
    ...
    public function show(Request $request, $id) {
        ...
        if(static::$authorize) $this->authorize('view', $item);
        return response()->json($item);
    }

    public function store(Request $request) {
        if(static::$authorize) $this->authorize('create', static::$model);
    ...
    public function update(Request $request, $id) {
        ...
        if(static::$authorize) $this->authorize('update', $item);
    ...
    public function destroy(Request $request, $id) {
        $item = (static::$repository)::show($id);
        if(static::$authorize) $this->authorize('delete', $item);
